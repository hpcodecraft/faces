  var Faces = {
    ...
    sort: function( by ) {
      ...
      for( x in Face ) {
        html = '\
          <div id="face_'+Face[x].id+'" class="face" data-face="'+app.baseurl+'/sites/'+app.face+'/faces/'+Face[x].file+'" data-id="'+Face[x].id+'">\
            <img class="face_thumb" data-original="'+app.baseurl+'/sites/'+app.face+'/thumbs/thumb_120_'+Face[x].file+'" src="http://a.squidpeople.com/transparent.gif"/>\
